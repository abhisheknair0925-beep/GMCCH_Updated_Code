...
<br>
<center><h1 style="font-size: 50px;color: #ff0088;letter-spacing: 5px;font-weight: 400;font-family: 'Abel', sans-serif;">APPROVE BOOKINGS</h1></center>
<br>
...
<table class="table">
  ...
  <tbody>
      ...
      include('connect.php');
      //$date = date('y-m-d');
      $view_users="SELECT * FROM tbl_booking WHERE tbl_booking_status='Requested'";
